  ...
  <div class="containerLogin">
    <div class="login-wrapper">
      ...
      <div class="form-wrapper">
        <input type="text" name="username" placeholder="用户名/工号" class="input-item" id="a_id" v-model="adminLogin.a_id">
        <input type="password" name="password" placeholder="密码" class="input-item" id="a_pwd" v-model="adminLogin.a_pwd">
...
const toRegister = () => {
  router.push({ path: "/security/register"});//跳转至,注册估计做不完了
}
