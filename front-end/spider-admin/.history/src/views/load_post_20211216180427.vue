  ...
  <div class="all">
    <div class="top-menu">
      <div class="font" style="text-align: center; margin-left: 250px">
        <a href="#" @click.prevent="home" style="color: black; font-size: 15px"
          >首页</a
        >
      </div>
      <div class="font" style="text-align: center; margin-left: 70px">
        <a href="#" @click.prevent="user" style="color: black; font-size: 15px"
          >个人中心</a
        >
      </div>
      <div class="font" style="text-align: center; margin-left: 60px">
        <a href="#" @click.prevent="post1" style="color: black; font-size: 15px"
          >我要发帖</a
        >
      </div>
      <div>
      ...
      <div style="margin-left: 530px">
        <a-dropdown>
          <template #overlay>
            <a-menu>
              <a-menu-item key="3" @click="info_update"
                >个人信息修改</a-menu-item
              >
    ...
    <div class="main">
      ...
      <div class="container">
        ...
        <div
          class="postContent"
          style="margin-left: 50px; margin-right: 50px; font-size: 22px"
        >
         <br />
          <p style="text-align: center" v-if="postContent.pimage_file != null">
            <img
              :src="postContent.pimage_file"
              alt="图片"
              style="height: 400px"
            />
          </p>
        ...
        <div class="toolBox" style="margin-left: 900px">
          ...
          <i
            class="fa fa-trash-o"
            @click="removePost(postContent.post_id)"
