      ...
      <a-dropdown>
        <template #overlay>
          <a-menu>
            ...
            <a-menu-item key="2" @click="search2">按昵称</a-menu-item>
          </a-menu>
        </template>
    ...
    <div class="mainSearch">
      ...
      <div class="contentSearch">
        <div class="row" v-for="item in resultList">
          ...
          <div class="rightContent" href="#" @click.prevent="loadUser(item.user_id)">
            <div class="title">
...
function loadUser(user_id) {
  router.push({
    path: "/loadUser",
    query: {userId:route.query.us userId2: user_id }
  });
}
