<template>
<div>文章管理</div>
        <div><button @click="loadList" class="btn btn-primary">show list</button></div>
        <div div class="all">
...
const loadList=function(){
    post("/admin/audit/loadpost",{
        audit_status:newPost.audit_status,post_id:newPost.post_id
    }).then((res)=>{
        console.log(res.data)
        resultList.value=res.data
            console.log("nmsl",resultList)});
};
