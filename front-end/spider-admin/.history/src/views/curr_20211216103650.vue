...
————————————————
版权声明：本文为CSDN博主「前端大猪草」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/weixin_38981993/article/details/82944629
const that = this;
const uploadAvatar = function(){
  that.$refs.avatarRef.click();
}
const handleFile = function() {
    avatarFile = that.$refs.avatarRef.files[0];
