...
class Home extends React.Component {
    ...
    toInfo(userId){
        this.props.history.push({pathname:'/i', state:{userId:userId}})
    }
        ...
        return (
            <div>
                ...
                <div className="bottomNav">
                    ...
                    <AppOutline />
                    <AddSquareOutline style={{ marginRight: 30, marginLeft: 30}} onClick = {() => {this.toPost(this.props.location.state.userId)}}/>
                    <UserOutline onClick = {() => {this.toInfo(this.props.location.state.userId)}}/>
                </div>
