...
class Info extends Component {
    ...
    getcollect(collectgroupid,userId) {
        Toast.show({
            content: "跳转中",
            afterClose: () => {
                this.props.history.push({ pathname: '/collect', state: { collectgroupid: collectgroupid, userId:this.props.location.state.userId } })
            },
        })
                        ...
                        <List>
                            {this.state.collectGroup.map(collectGroup => (
                                <List.Item
                                    ...
                                    onClick={() => this.getcollect(collectGroup.collect_group_id, this.props.location.state.userId)}
