...
import { UnorderedListOutline, PayCircleOutline, SetOutline, MessageOutline, MessageFill, FileOutline, UserOutline, } from 'antd-mobile-icons'
...
class OtherInfo extends Component {
    ...
    componentDidMount() {
        ...
        $axios.post('/user/favorites/view_other_list', {
            "user_id":this.props.location.state.otherId,
        }).then(res => {
            console.log(res)
            this.setState({
    ...
    getcollect(collectgroupid) {
        Toast.show({
            ...
            duration: 100,
            afterClose: () => {
                this.props.history.push({ pathname: '/othercollect', state: { collectgroupid: collectgroupid } })
            },
        })
    }
