...
class Login extends Component {
            ...
            <div>
                ...
                <div className="login">
                    ...
                    <div>
                        ...
                        <input id="user_id" className="id_" placeholder='请输入用户名' clearable />
                    </div>

                    <div>
                        <LockOutline className="textImg" fontSize="40px"/>
                        <input id="user_pwd" type="password" className="pwd_" placeholder='请输入密码' />
                    </div>
                    ...
                    <text className="phoneLogin" onClick={() => {this.toPhoneLogin()} }>手机验证码登录</text>
    ...
    toPhoneLogin(){
        this.props.history.push({ pathname: '/phoneLogin'})
    }
}
